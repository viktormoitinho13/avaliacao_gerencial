                        ...
                        <div class="col align-self-start col-12 col-sm-12 col-md-8	col-lg-6 col-xl-6 col-xxl-4">
                            <div class="card mx-auto mb-4 mt-4 shadow  bg-white rounded "
                                ...
                                <div class="card-body text-primary">
                                    <h1 class="title text-center text-dark mt-4" style="font-size: 50px;">Avaliação gerencial </h1>
                                    ...
                                    <div class="container-md mx-auto ">
                                        <div class="d-flex justify-content-center">
                                            <p class="card-text text-justify text-dark mt-4 col-8  "
                                                ...
                                                ferramenta de <b>Feedbacks com a finalidade de melhorar os desempenhos</b> 
                                                dentro da nossa organização. Você está recebendo esse formulário para <b>
                                                avaliar o desempenho do seu gerente</b>, para que ele possa receber um 
                                                ...
                                                com sinceridade para que tenhamos direcionamento para melhorarmos juntos.
                                    ...
                                    <div class="container-md mx-auto ">
                                        <div class="d-flex justify-content-center">
                                            <p class="card-text text-justify text-dark mt-4 col-8  "
                                                ...
                                                do seu desempenho pelos  seus colaboradores</b>, para que você possa receber um 
                                                feedback e ter a oportunidade de se  desenvolver conosco.
                                                <b>Essa avaliação é referente as ações ocorridas nos últimos meses</b>. </p>
                                        </div>
                                    </div>
                                    <div class="text-center">
