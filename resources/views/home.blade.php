...
<div class="row mt-5">
 @foreach ($classificacoes as $classificacao)
  <div class="col align-self-start col-12 col-sm-6 col-md-6	col-lg-6 col-xl-6 col-xxl-3">
    ...
    <img src="{{URL::asset('/imgs/capa.jpg')}}" alt="profile Pic"   class="img-fluid" alt="Sample image"  class="card-img-top" alt="...">
      <div class="card-body">
        ...
        <a href="/form/{{ $classificacao->AG_CLASSIFICACAO }}" class="btn" style="background-color: #6B9DD8; color:white;">Go somewhere</a>
      </div>
    </div>
  </div>
@endforeach
