                        ...
                        <div class="card mx-auto mb-4 mt-4 shadow  bg-white rounded "
                            ...
                            <div class="card-body text-primary">
                                ...
                                @foreach ($gerenteNome as $gerenteNome)
                                    <p class="fw-normal  text-center text-capitalize mt-4" style="font-size: 25px; color:#268bff;">
                                       {{ $gerenteNome->NOME }} </p>
                                @endforeach
                                <div class="container-md mx-auto ">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <p class="card-text text-justify text-dark mt-4 col-8  "
                                            ...
                                            Faz parte da <b>cultura da nossa empresa </b> dar suporte ao desenvolvimento
                                            dos
                                            nossos colaboradores, para isso utilizamos a ferramenta de <b>Feedbacks com
                                                a
                                            ...
                                            desenvolver conosco.
                                            A avaliação é <b>obrigatória e sigilosa</b>, pedimos que você responda com
                                            sinceridade para
